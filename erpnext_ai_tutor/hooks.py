...
app_include_js = [
	f"/assets/erpnext_ai_tutor/js/ai_tutor/utils.js?v={ASSET_VERSION}",
	f"/assets/erpnext_ai_tutor/js/ai_tutor/guide.js?v={ASSET_VERSION}",
	f"/assets/erpnext_ai_tutor/js/ai_tutor/widget_core.js?v={ASSET_VERSION}",
	f"/assets/erpnext_ai_tutor/js/ai_tutor/widget.js?v={ASSET_VERSION}",
	f"/assets/erpnext_ai_tutor/js/ai_tutor/boot.js?v={ASSET_VERSION}",
]
